defmodule Songrep.IdentityTest do
  use Songrep.DataCase

  alias Songrep.Identity

  describe "users" do
    alias Songrep.Identity.User

    @valid_attrs %{address: "some address", age: "some age", name: "some name"}
    @update_attrs %{address: "some updated address", age: "some updated age", name: "some updated name"}
    @invalid_attrs %{address: nil, age: nil, name: nil}
